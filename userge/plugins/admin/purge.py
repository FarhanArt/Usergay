...
async def purge_(message: Message):
    await message.edit("`Sedang menghapus kenangan ...`")
    from_user_id = None
    ...
    out = f"<u>Berhasil menghapus</u> {purged_messages_count} kenangan dalam {time_taken_s} detik."
    await message.edit(out, del_in=2)
